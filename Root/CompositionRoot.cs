...
namespace Root
{
    public class CompositionRoot
    {
        ...
        public static void InjectDependencies(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProjectContext>(options => options.UseSqlServer("server=DESKTOP-CKPPIUF ;database=AskBilisimCodeFirst ; Trusted_Connection = true", x => x.MigrationsAssembly("UI")));
        }
    }
}